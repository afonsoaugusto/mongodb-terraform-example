...
Um **provider** é responsavel por traduzir a implementação realizada em [HCL](https://www.terraform.io/docs/configuration/syntax.html)(notação que a engine do terraform implementa) e a API do objeto de destino seja ela um Cloud Provider ou outro item de infraestrutura.
